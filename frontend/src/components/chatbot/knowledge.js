export const ALGOFORCE_KNOWLEDGE = {
    ...
    services: {
        ...
        chatbots_rag: {
            ...
            description: "Custom LLM bots that ingest your business data.",
        ...
        aeo_seo: {
            ...
            description: "Optimization for ChatGPT, Perplexity, and Claude.",
            pricing: "Included in Growth/Domination packs."
        }
    },
    packages: [
        {
