...
const PRODUCTS = [
  {
    ...
    outcome: 'Reduce manual reconciliation effort and surface accounting exceptions earlier in the process.',
    category: 'finance',
    featured: true,
    icon: <FaBrain />,
    color: '#8f38ff',
  ...
  },
  {
    ...
    outcome: 'More consistent lead follow-up, faster response times, and reduced manual sales coordination.',
    category: 'sales',
    featured: true,
    icon: <FaChartLine />,
    color: '#7aa7c7',
  ...
  },
  {
    ...
    outcome: 'More consistent guest communication, fewer missed inquiries, and reduced front-desk workload.',
  ...
  },
  {
    ...
    outcome: 'Earlier defect detection, automatic error logging, and reduced dependence on manual visual inspection.',
  ...
  },
  {
    ...
    outcome: 'Faster access to standard operating procedures and better preservation of institutional knowledge.',
    category: 'knowledge',
    icon: <FaBrain />,
    color: '#8f38ff',
  ...
  },
  {
    ...
    outcome: 'Better operational visibility, automated reporting, and faster access to cost and performance data.',
    category: 'analytics',
    icon: <FaCogs />,
    color: '#7aa7c7',
    integrations: ['PostgreSQL', 'MongoDB', 'Supabase', 'BigQuery'],
    hosting: ['Secure Cloud Hosting', 'Private Cloud Server'],
    details: 'Synthesizes scattered database tables into real-time decision dashboards, highlighting process bottlenecks and calculating department performance automatically.'
  },
  {
    ...
    outcome: 'Better inventory visibility, earlier reorder alerts, and less manual stock reconciliation.',
    category: 'operations',
    icon: <FaDatabase />,
    color: '#b783ff',
  ...
  },
  {
    ...
    outcome: 'Reduced tax credit mismatch risk and less manual effort in GST reconciliation and filing preparation.',
    category: 'finance',
    icon: <FaCogs />,
    color: '#8f38ff',
  ...
  },
  {
    ...
    outcome: 'Faster employee query resolution, more consistent onboarding, and reduced repetitive HR workload.',
    category: 'hr',
    icon: <FaUsers />,
    color: '#8f38ff',
