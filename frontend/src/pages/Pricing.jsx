  ...
  const pricingTiers = [
    {
      ...
      cta: 'Schedule Audit',
      ctaLink: 'https://buy.stripe.com/test_aFaeVceFhgHYaASa3o0Ny00',
      highlight: false,
            ...
            <div className="grid gap-8 md:grid-cols-3">
              {pricingTiers.map((tier, index) => (
                <motion.div
                  ...
                  className={`relative bg-white rounded-3xl shadow-xl overflow-hidden ${tier.highlight ? 'border-4 border-purple-500 md:-mt-8' : 'border border-gray-200'
                    }`}
                >
                  {/* Badge */}
                  {tier.badge && (
                    ...
                    {tier.ctaLink ? (
                      <a href={tier.ctaLink} target="_blank" rel="noopener noreferrer">
                        <motion.button
                          ...
                          whileTap={{ scale: 0.95 }}
                          className={`w-full py-4 rounded-lg font-semibold flex items-center justify-center gap-2 transition-all ${tier.highlight
